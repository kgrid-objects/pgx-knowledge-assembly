...
- An Info Page automatically generated from the PGx-KA's own metadata file can be viewed online [here](https://kgrid-objects.github.io/pgx-knowledge-assembly/pgx_kb_info_page.html).
